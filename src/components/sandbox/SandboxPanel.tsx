...
export const SandboxPanel = ({
  ...
  return (
    <aside className="panel sandbox-panel">
      ...
      <p className="muted">
        Runs simulation locally using workflow graph + context.
      </p>
          ...
          <ul>
            {validationIssues.map((issue, index) => (
              <li
                ...
                className={issue.level === 'error' ? 'error' : 'warning'}
              >
      ...
      {result && (
        <div className="simulation-result">
          ...
          {resultSummary && (
            <div className="result-stats">
              ...
              <span className="stat-chip warning">
                Warnings: {resultSummary.warning}
              </span>
              <span className="stat-chip error">
                Errors: {resultSummary.error}
              </span>
            </div>
          )}
          ...
          {result.issues.length > 0 && (
            <div className="issues-box">
              <strong>Simulation Issues</strong>
              <ul>
